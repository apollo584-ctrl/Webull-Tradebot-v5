...
- All lock-bound text hashes normalize only platform newline encoding, so identical committed content verifies on Windows and LF-based systems; the regenerated candidate and protocol locks pin commit `bd73ac9f5147466ec5526203cbee4fe446593de3`.
